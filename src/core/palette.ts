...
export const BUILTIN_PALETTES: Readonly<Record<string, DistrictPalette>> = Object.freeze({
  corporate: district("Corporate", [
    ...
    lit(rgb(0.205, 0.145, 0.090), rgb(0.72, 0.48, 0.24), 0.06),        // WALL_C: restrained bronze contrast tier
    ...
    lit(rgb(0.104, 0.108, 0.114), rgb(0.72, 0.76, 0.82), 0.015),       // ROOF_C: neutral graphite service roof
    lit(rgb(0.012, 0.016, 0.020), rgb(0.50, 0.82, 1.0), 1.5),
    lit(rgb(0.018, 0.014, 0.008), rgb(1.0, 0.58, 0.22), 1.25)
  ]),
  commercial: district("Commercial", [
    ...
    lit(rgb(0.200, 0.105, 0.170), rgb(0.78, 0.24, 0.62), 0.06),        // WALL_C: restrained magenta contrast tier
    ...
    lit(rgb(0.100, 0.110, 0.112), rgb(0.72, 0.80, 0.82), 0.015),       // ROOF_C: neutral graphite service roof
    lit(rgb(0.008, 0.018, 0.020), rgb(0.18, 0.95, 0.92), 1.6),
    lit(rgb(0.018, 0.008, 0.016), rgb(0.98, 0.24, 0.70), 1.45)
  ]),
  "mixed-use": district("Mixed Use", [
    ...
    lit(rgb(0.080, 0.175, 0.182), rgb(0.24, 0.68, 0.72), 0.06),        // WALL_C: restrained teal contrast tier
    ...
    lit(rgb(0.110, 0.105, 0.098), rgb(0.78, 0.75, 0.70), 0.015),       // ROOF_C: neutral warm-grey service roof
  ...
  "residential-mega": district("Residential Mega", [
    ...
    lit(rgb(0.190, 0.155, 0.085), rgb(0.72, 0.56, 0.28), 0.06),        // WALL_C: restrained amber contrast tier
    ...
    lit(rgb(0.098, 0.110, 0.104), rgb(0.70, 0.78, 0.74), 0.015),       // ROOF_C: neutral graphite service roof
  ...
  "residential-dense": district("Residential Dense", [
    ...
    lit(rgb(0.073, 0.170, 0.174), rgb(0.24, 0.68, 0.72), 0.06),        // WALL_C: restrained teal contrast tier
    ...
    lit(rgb(0.112, 0.102, 0.098), rgb(0.78, 0.72, 0.70), 0.015),       // ROOF_C: neutral warm-grey service roof
    lit(rgb(0.020, 0.010, 0.006), rgb(1.0, 0.45, 0.22), 1.55),
    lit(rgb(0.008, 0.018, 0.022), rgb(0.20, 0.90, 1.0), 1.4)
  ]),
  "residential-low": district("Residential Low", [
    ...
    lit(rgb(0.145, 0.120, 0.190), rgb(0.58, 0.42, 0.76), 0.06),        // WALL_C: restrained violet contrast tier
    ...
    lit(rgb(0.104, 0.109, 0.098), rgb(0.74, 0.78, 0.70), 0.015),       // ROOF_C: neutral warm-grey service roof
    lit(rgb(0.014, 0.018, 0.008), rgb(0.65, 0.98, 0.35), 1.4),
    lit(rgb(0.014, 0.008, 0.020), rgb(0.72, 0.42, 1.0), 1.25)
  ]),
  "night-market": district("Night Market", [
    ...
    lit(rgb(0.070, 0.172, 0.165), rgb(0.20, 0.70, 0.66), 0.06),        // WALL_C: restrained teal contrast tier
    ...
    lit(rgb(0.108, 0.099, 0.104), rgb(0.76, 0.70, 0.74), 0.015),       // ROOF_C: neutral graphite service roof
  ...
  entertainment: district("Entertainment", [
    ...
    lit(rgb(0.200, 0.158, 0.080), rgb(0.78, 0.58, 0.22), 0.06),        // WALL_C: restrained gold contrast tier
    ...
    lit(rgb(0.105, 0.100, 0.112), rgb(0.74, 0.70, 0.80), 0.015),       // ROOF_C: neutral graphite service roof
  ...
  "old-city": district("Old City", [
    ...
    lit(rgb(0.075, 0.170, 0.172), rgb(0.22, 0.68, 0.70), 0.06),        // WALL_C: restrained teal contrast tier
    ...
    lit(rgb(0.112, 0.105, 0.096), rgb(0.80, 0.76, 0.68), 0.015),       // ROOF_C: neutral warm-grey service roof
  ...
  "industrial-heavy": district("Industrial Heavy", [
    ...
    lit(rgb(0.105, 0.145, 0.182), rgb(0.38, 0.58, 0.74), 0.06),        // WALL_C: restrained steel-blue contrast tier
    ...
    lit(rgb(0.104, 0.102, 0.096), rgb(0.74, 0.72, 0.68), 0.015),       // ROOF_C: neutral soot-grey service roof
    lit(rgb(0.020, 0.012, 0.004), rgb(1.0, 0.58, 0.15), 1.4),
    lit(rgb(0.006, 0.016, 0.022), rgb(0.22, 0.85, 1.0), 1.25)
  ]),
  "industrial-light": district("Industrial Light", [
    ...
    lit(rgb(0.190, 0.125, 0.082), rgb(0.72, 0.45, 0.22), 0.06),        // WALL_C: restrained rust contrast tier
    ...
    lit(rgb(0.102, 0.108, 0.114), rgb(0.72, 0.76, 0.82), 0.015),       // ROOF_C: neutral graphite service roof
  ...
  "logistics-port": district("Logistics Port", [
    ...
    lit(rgb(0.112, 0.092, 0.074), rgb(0.50, 0.36, 0.22), 0.03),        // ROOF_B: brown aggregate, dominant dock tier
    lit(rgb(0.107, 0.105, 0.100), rgb(0.76, 0.74, 0.70), 0.015),       // ROOF_C: neutral concrete service roof
  ...
  waterfront: district("Waterfront", [
    ...
    lit(rgb(0.205, 0.122, 0.098), rgb(0.78, 0.40, 0.30), 0.06),        // WALL_C: restrained coral contrast tier
    ...
    lit(rgb(0.100, 0.108, 0.114), rgb(0.72, 0.76, 0.82), 0.015),       // ROOF_C: neutral graphite service roof
    lit(rgb(0.006, 0.016, 0.022), rgb(0.22, 0.90, 1.0), 1.6),
    lit(rgb(0.020, 0.010, 0.008), rgb(1.0, 0.40, 0.28), 1.4)
  ]),
  civic: district("Civic", [
    ...
    lit(rgb(0.105, 0.145, 0.195), rgb(0.38, 0.58, 0.78), 0.05),        // WALL_C: restrained civic-blue contrast tier
    ...
    lit(rgb(0.114, 0.111, 0.105), rgb(0.80, 0.78, 0.74), 0.015),       // ROOF_C: neutral mineral service roof
  ...
  utility: district("Utility", [
    ...
    lit(rgb(0.095, 0.145, 0.185), rgb(0.35, 0.58, 0.76), 0.06),        // WALL_C: restrained service-blue contrast tier
    ...
    lit(rgb(0.106, 0.105, 0.096), rgb(0.76, 0.74, 0.68), 0.015),       // ROOF_C: neutral soot-grey service roof
    lit(rgb(0.016, 0.016, 0.005), rgb(0.88, 0.95, 0.22), 1.4),
    lit(rgb(0.008, 0.016, 0.022), rgb(0.25, 0.82, 1.0), 1.3)
  ]),
  derelict: district("Derelict", [
    ...
    lit(rgb(0.085, 0.153, 0.145), rgb(0.30, 0.62, 0.58), 0.05),        // WALL_C: weathered teal contrast tier
    ...
    lit(rgb(0.105, 0.101, 0.098), rgb(0.74, 0.70, 0.68), 0.015),       // ROOF_C: neutral soot-grey service roof
    lit(rgb(0.018, 0.012, 0.006), rgb(0.95, 0.58, 0.28), 1.25),
    lit(rgb(0.010, 0.008, 0.020), rgb(0.52, 0.38, 1.0), 1.25)
  ])
});
