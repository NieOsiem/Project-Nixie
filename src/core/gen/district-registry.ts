...
export const DISTRICT_TYPES: readonly DistrictTypeDefinition[] = Object.freeze([
  ...
  district("entertainment-strip", "Entertainment Strip", "entertainment", { "fine-grain-frontage": 0.48, "market-alley": 0.26, "rotated-bands": 0.16, "perimeter-courtyard": 0.1 }, { minCellWidthM: 8, maxCellWidthM: 28, minCellDepthM: 18, maxCellDepthM: 48, minAspect: 0.2, maxAspect: 4.8 }, 1.0, categories(1, 5, 4, 0.5, 0.2, 1, 1), sizes(3, 5, 2, 0.5), ["market", "fine-grain"], building({ "entertainment-signage-podium": 0.3, "market-corner": 0.23, "narrow-shopfront": 0.2, "corner-flatiron": 0.16, "narrow-strip": 0.11 }), uses({ entertainment: 0.5, commercial: 0.3, "mixed-use": 0.2 })),
  district("old-city", "Old City", "old-city", { "irregular-mosaic": 0.4, "radial-fan": 0.28, "fine-grain-frontage": 0.2, "market-alley": 0.12 }, { minCellWidthM: 6, maxCellWidthM: 22, minCellDepthM: 9, maxCellDepthM: 30, minAspect: 0.24, maxAspect: 4 }, 0.78, categories(2, 4, 0.5, 1.5, 0.2, 2, 1), sizes(5, 4, 1, 0.2), ["irregular", "fine-grain"], building({ "old-city-courtyard": 0.3, "corner-flatiron": 0.21, "market-corner": 0.19, "narrow-shopfront": 0.15, "street-kiosk": 0.09, "shack-shanty": 0.08, "narrow-strip": 0.08 }), uses({ "mixed-use": 0.4, residential: 0.35, commercial: 0.25 })),
  // Tuned: cell bounds, block grammar weights, building grammar weights
