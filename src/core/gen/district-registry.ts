...
export const DISTRICT_TYPES: readonly DistrictTypeDefinition[] = Object.freeze([
  district("corporate-core", "Corporate Core", "corporate", { "tower-podium-field": 0.48, "perimeter-courtyard": 0.24, "campus-pavilions": 0.16, "rotated-bands": 0.12 }, { minCellWidthM: 24, maxCellWidthM: 54, minCellDepthM: 28, maxCellDepthM: 66, minAspect: 0.55, maxAspect: 2.4 }, 0.6, categories(2, 5, 1, 0.5, 0.5, 3, 0.5), sizes(1, 3, 4, 1), ["formal"], building({ "corporate-tower-podium": 0.4, "corporate-atrium-block": 0.24, "wedge-office": 0.16, "civic-tower-plinth": 0.1, "commercial-twin-tower-podium": 0.1 }), uses({ commercial: 0.5, civic: 0.3, "mixed-use": 0.2 })),
  district("commercial-highrise", "Commercial Highrise", "commercial", { "tower-podium-field": 0.36, "fine-grain-frontage": 0.28, "perimeter-courtyard": 0.2, "rotated-bands": 0.16 }, { minCellWidthM: 14, maxCellWidthM: 44, minCellDepthM: 24, maxCellDepthM: 58, minAspect: 0.38, maxAspect: 2.9 }, 0.72, categories(1, 4, 2, 0.5, 0.5, 2, 1), sizes(2, 4, 3, 1), ["formal", "fine-grain"], building({ "commercial-twin-tower-podium": 0.32, "wedge-office": 0.22, "corporate-tower-podium": 0.2, "dense-perimeter-block": 0.14, "narrow-shopfront": 0.12 }), uses({ commercial: 0.6, "mixed-use": 0.3, entertainment: 0.1 })),
  district("mixed-use-centre", "Mixed Use Centre", "mixed-use", { "fine-grain-frontage": 0.34, "perimeter-courtyard": 0.28, "irregular-mosaic": 0.22, "market-alley": 0.16 }, { minCellWidthM: 9, maxCellWidthM: 32, minCellDepthM: 14, maxCellDepthM: 42, minAspect: 0.3, maxAspect: 3.2 }, 0.9, categories(3, 4, 1.5, 1, 0.5, 2, 1), sizes(3, 5, 2, 0.5), ["fine-grain", "market"], building({ "dense-perimeter-block": 0.3, "narrow-shopfront": 0.24, "market-corner": 0.2, "old-city-courtyard": 0.14, "corner-flatiron": 0.12 }), uses({ "mixed-use": 0.5, commercial: 0.3, residential: 0.2 })),
  // Tuned: cell bounds, block grammar weights, building grammar weights
  district("residential-megablocks", "Residential Megablocks", "residential-mega", { "perimeter-courtyard": 0.6, "fine-grain-frontage": 0.25, "superblock-compound": 0.15 }, { minCellWidthM: 22, maxCellWidthM: 50, minCellDepthM: 22, maxCellDepthM: 50, minAspect: 0.5, maxAspect: 2.2 }, 1.05, categories(5, 1, 1.5, 0.5, 0.5, 4, 0.5), sizes(1, 4, 5, 2), ["residential", "campus"], building({ "megablock-ring": 0.5, "dense-perimeter-block": 0.3, "residential-court": 0.15, "civic-pavilion": 0.05 }), uses({ residential: 0.7, "mixed-use": 0.2, civic: 0.1 })),
  district("dense-residential", "Dense Residential", "residential-dense", { "perimeter-courtyard": 0.38, "fine-grain-frontage": 0.3, "irregular-mosaic": 0.2, "rotated-bands": 0.12 }, { minCellWidthM: 8, maxCellWidthM: 26, minCellDepthM: 16, maxCellDepthM: 38, minAspect: 0.3, maxAspect: 3.6 }, 0.86, categories(4, 1, 1, 0.5, 0.3, 3, 0.4), sizes(4, 5, 1, 0.2), ["residential", "fine-grain"], building({ "residential-slab": 0.4, "residential-wing": 0.24, "residential-court": 0.16, "old-city-courtyard": 0.2 }), uses({ residential: 0.8, "mixed-use": 0.2 })),
  // Tuned: open space multiplier
  district("low-rise-residential", "Low-Rise Residential", "residential-low", { "rotated-bands": 0.34, "fine-grain-frontage": 0.28, "irregular-mosaic": 0.2, "campus-pavilions": 0.18 }, { minCellWidthM: 10, maxCellWidthM: 30, minCellDepthM: 12, maxCellDepthM: 34, minAspect: 0.4, maxAspect: 2.8 }, 0.85, categories(5, 0.5, 1, 0.7, 0.3, 5, 0.3), sizes(6, 4, 1, 0.2), ["residential"], building({ "residential-wing": 0.36, "residential-slab": 0.3, "residential-court": 0.22, "dense-perimeter-block": 0.12 }), uses({ residential: 0.9, "mixed-use": 0.1 })),
  district("night-market", "Night Market", "night-market", { "market-alley": 0.44, "fine-grain-frontage": 0.32, "radial-fan": 0.14, "irregular-mosaic": 0.1 }, { minCellWidthM: 5, maxCellWidthM: 16, minCellDepthM: 8, maxCellDepthM: 24, minAspect: 0.22, maxAspect: 4.5 }, 0.82, categories(1, 6, 1, 0.5, 0.2, 1, 2), sizes(6, 4, 1, 0.2), ["market", "fine-grain"], building({ "market-corner": 0.36, "narrow-shopfront": 0.28, "corner-flatiron": 0.2, "residential-slab": 0.16 }), uses({ entertainment: 0.4, commercial: 0.35, "mixed-use": 0.25 })),
  // Tuned: block grammar weights (removed logistics-sheds, added weight to fine-grain-frontage)
  district("entertainment-strip", "Entertainment Strip", "entertainment", { "fine-grain-frontage": 0.48, "market-alley": 0.26, "rotated-bands": 0.16, "perimeter-courtyard": 0.1 }, { minCellWidthM: 8, maxCellWidthM: 28, minCellDepthM: 18, maxCellDepthM: 48, minAspect: 0.2, maxAspect: 4.8 }, 1.0, categories(1, 5, 4, 0.5, 0.2, 1, 1), sizes(3, 5, 2, 0.5), ["market", "fine-grain"], building({ "entertainment-signage-podium": 0.34, "market-corner": 0.26, "narrow-shopfront": 0.22, "corner-flatiron": 0.18 }), uses({ entertainment: 0.5, commercial: 0.3, "mixed-use": 0.2 })),
  district("old-city", "Old City", "old-city", { "irregular-mosaic": 0.4, "radial-fan": 0.28, "fine-grain-frontage": 0.2, "market-alley": 0.12 }, { minCellWidthM: 6, maxCellWidthM: 22, minCellDepthM: 9, maxCellDepthM: 30, minAspect: 0.24, maxAspect: 4 }, 0.78, categories(2, 4, 0.5, 1.5, 0.2, 2, 1), sizes(5, 4, 1, 0.2), ["irregular", "fine-grain"], building({ "old-city-courtyard": 0.36, "corner-flatiron": 0.24, "market-corner": 0.22, "narrow-shopfront": 0.18 }), uses({ "mixed-use": 0.4, residential: 0.35, commercial: 0.25 })),
  // Tuned: cell bounds, block grammar weights, building grammar weights
  district("heavy-industrial", "Heavy Industrial", "industrial-heavy", { "industrial-yard": 0.38, "logistics-sheds": 0.4, "rotated-bands": 0.22 }, { minCellWidthM: 20, maxCellWidthM: 48, minCellDepthM: 22, maxCellDepthM: 54, minAspect: 0.32, maxAspect: 3.8 }, 0.9, categories(0.2, 0.1, 2, 1.5, 5, 0.3, 6), sizes(0.5, 2, 5, 4), ["industrial"], building({ "industrial-shed": 0.45, "industrial-loading-court": 0.3, "service-court-works": 0.2, "stacked-workshop": 0.05 }), uses({ industrial: 0.6, logistics: 0.25, utility: 0.15 })),
  // Tuned: cell bounds, block grammar weights, building grammar weights
  district("light-industrial", "Light Industrial", "industrial-light", { "fine-grain-frontage": 0.4, "rotated-bands": 0.35, "industrial-yard": 0.25 }, { minCellWidthM: 14, maxCellWidthM: 34, minCellDepthM: 16, maxCellDepthM: 38, minAspect: 0.35, maxAspect: 3.4 }, 0.92, categories(0.5, 0.3, 3, 1, 4, 0.8, 5), sizes(1, 3, 5, 2), ["industrial"], building({ "stacked-workshop": 0.45, "service-court-works": 0.3, "industrial-shed": 0.2, "utility-service-cluster": 0.05 }), uses({ industrial: 0.55, logistics: 0.3, utility: 0.15 })),
  // Tuned: cell depth bounds
  district("logistics-port", "Logistics Port", "logistics-port", { "logistics-sheds": 0.5, "industrial-yard": 0.26, "waterfront-terraces": 0.16, "rotated-bands": 0.08 }, { minCellWidthM: 26, maxCellWidthM: 72, minCellDepthM: 36, maxCellDepthM: 72, minAspect: 0.18, maxAspect: 5.5 }, 1.0, categories(0.2, 0.2, 3, 1, 3, 0.3, 7), sizes(0.5, 2, 5, 5), ["industrial", "waterfront"], building({ "industrial-shed": 0.32, "industrial-loading-court": 0.26, "service-court-works": 0.22, "utility-service-cluster": 0.2 }), uses({ logistics: 0.6, industrial: 0.3, utility: 0.1 })),
  // Tuned: open space multiplier
  district("waterfront", "Waterfront", "waterfront", { "waterfront-terraces": 0.46, "rotated-bands": 0.2, "fine-grain-frontage": 0.16, "campus-pavilions": 0.1, "perimeter-courtyard": 0.08 }, { minCellWidthM: 12, maxCellWidthM: 38, minCellDepthM: 16, maxCellDepthM: 50, minAspect: 0.32, maxAspect: 3.8 }, 1.05, categories(5, 4, 1, 0.5, 0.2, 4, 0.4), sizes(3, 5, 3, 1), ["waterfront"], building({ "waterfront-step": 0.36, "residential-slab": 0.2, "dense-perimeter-block": 0.16, "corporate-tower-podium": 0.14, "corner-flatiron": 0.14 }), uses({ "mixed-use": 0.4, residential: 0.3, entertainment: 0.2, commercial: 0.1 })),
  district("civic-institutional", "Civic and Institutional", "civic", { "campus-pavilions": 0.4, "radial-fan": 0.26, "perimeter-courtyard": 0.2, "tower-podium-field": 0.14 }, { minCellWidthM: 18, maxCellWidthM: 48, minCellDepthM: 20, maxCellDepthM: 54, minAspect: 0.5, maxAspect: 2.5 }, 1.45, categories(5, 5, 0.5, 0.2, 0.8, 5, 0.3), sizes(1, 4, 5, 2), ["formal", "campus"], building({ "civic-pavilion": 0.28, "civic-entry-court": 0.22, "civic-tower-plinth": 0.18, "corporate-atrium-block": 0.14, "megablock-ring": 0.1, "residential-court": 0.08 }), uses({ civic: 0.7, commercial: 0.2, "mixed-use": 0.1 })),
  // Tuned: cell bounds, open space multiplier, building grammar weights
  district("utility-infrastructure", "Utility Infrastructure", "utility", { "industrial-yard": 0.42, "superblock-compound": 0.26, "campus-pavilions": 0.2, "irregular-mosaic": 0.12 }, { minCellWidthM: 16, maxCellWidthM: 38, minCellDepthM: 18, maxCellDepthM: 42, minAspect: 0.42, maxAspect: 3 }, 0.7, categories(0.1, 0.1, 1, 1, 8, 0.5, 5), sizes(0.5, 2, 5, 5), ["industrial", "campus"], building({ "industrial-shed": 0.4, "stacked-workshop": 0.3, "service-court-works": 0.2, "utility-service-cluster": 0.1 }), uses({ utility: 0.6, industrial: 0.3, logistics: 0.1 })),
  // Tuned: cell bounds, open space multiplier, building grammar weights
  district("derelict-reclamation", "Derelict Reclamation", "derelict", { "irregular-mosaic": 0.38, "industrial-yard": 0.24, "radial-fan": 0.18, "rotated-bands": 0.12, "fine-grain-frontage": 0.08 }, { minCellWidthM: 12, maxCellWidthM: 30, minCellDepthM: 14, maxCellDepthM: 34, minAspect: 0.26, maxAspect: 4.2 }, 0.9, categories(1, 0.5, 1, 6, 4, 1, 4), sizes(2, 4, 4, 3), ["irregular", "industrial"], building({ "stacked-workshop": 0.4, "service-court-works": 0.28, "derelict-reclamation-cluster": 0.2, "old-city-courtyard": 0.12 }), uses({ industrial: 0.4, utility: 0.3, residential: 0.2, "mixed-use": 0.1 }))
]);
