...
export const DISTRICT_TYPES: readonly DistrictTypeDefinition[] = Object.freeze([
  ...
  district("old-city", "Old City", "old-city", { "irregular-mosaic": 0.4, "radial-fan": 0.28, "fine-grain-frontage": 0.2, "market-alley": 0.12 }, { minCellWidthM: 6, maxCellWidthM: 22, minCellDepthM: 9, maxCellDepthM: 30, minAspect: 0.24, maxAspect: 4 }, 0.78, categories(2, 4, 0.5, 1.5, 0.2, 2, 1), sizes(5, 4, 1, 0.2), ["irregular", "fine-grain"], building({ "old-city-courtyard": 0.32, "corner-flatiron": 0.22, "market-corner": 0.2, "narrow-shopfront": 0.16, "street-kiosk": 0.1, "shack-shanty": 0.08 }), uses({ "mixed-use": 0.4, residential: 0.35, commercial: 0.25 })),
  // Tuned: cell bounds, block grammar weights, building grammar weights
  ...
  // Tuned: cell bounds, block grammar weights, building grammar weights
  district("light-industrial", "Light Industrial", "industrial-light", { "fine-grain-frontage": 0.4, "rotated-bands": 0.35, "industrial-yard": 0.25 }, { minCellWidthM: 14, maxCellWidthM: 34, minCellDepthM: 16, maxCellDepthM: 38, minAspect: 0.35, maxAspect: 3.4 }, 0.92, categories(0.5, 0.3, 3, 1, 4, 0.8, 5), sizes(1, 3, 5, 2), ["industrial"], building({ "stacked-workshop": 0.4, "service-court-works": 0.26, "industrial-shed": 0.18, "utility-service-cluster": 0.04, "garage-unit": 0.08, "utility-kiosk": 0.04 }), uses({ industrial: 0.55, logistics: 0.3, utility: 0.15 })),
  ...
  // Tuned: cell bounds, open space multiplier, building grammar weights
  district("derelict-reclamation", "Derelict Reclamation", "derelict", { "irregular-mosaic": 0.38, "industrial-yard": 0.24, "radial-fan": 0.18, "rotated-bands": 0.12, "fine-grain-frontage": 0.08 }, { minCellWidthM: 12, maxCellWidthM: 30, minCellDepthM: 14, maxCellDepthM: 34, minAspect: 0.26, maxAspect: 4.2 }, 0.9, categories(1, 0.5, 1, 6, 4, 1, 4), sizes(2, 4, 4, 3), ["irregular", "industrial"], building({ "stacked-workshop": 0.32, "service-court-works": 0.22, "derelict-reclamation-cluster": 0.16, "old-city-courtyard": 0.1, "shack-shanty": 0.12, "garage-unit": 0.08 }), uses({ industrial: 0.4, utility: 0.3, residential: 0.2, "mixed-use": 0.1 }))
]);
