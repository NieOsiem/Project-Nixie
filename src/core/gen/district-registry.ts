...
export const DISTRICT_TYPES: readonly DistrictTypeDefinition[] = Object.freeze([
  ...
  district("entertainment-strip", "Entertainment Strip", "entertainment", { "fine-grain-frontage": 0.3, "market-alley": 0.26, "logistics-sheds": 0.18, "rotated-bands": 0.16, "perimeter-courtyard": 0.1 }, { minCellWidthM: 8, maxCellWidthM: 28, minCellDepthM: 18, maxCellDepthM: 48, minAspect: 0.2, maxAspect: 4.8 }, 1.0, categories(1, 5, 4, 0.5, 0.2, 1, 1), sizes(3, 5, 2, 0.5), ["market", "fine-grain"], building({ "entertainment-signage-podium": 0.34, "market-corner": 0.26, "narrow-shopfront": 0.22, "corner-flatiron": 0.18 }), uses({ entertainment: 0.5, commercial: 0.3, "mixed-use": 0.2 })),
  ...
  district("heavy-industrial", "Heavy Industrial", "industrial-heavy", { "industrial-yard": 0.52, "logistics-sheds": 0.28, "superblock-compound": 0.14, "rotated-bands": 0.06 }, { minCellWidthM: 36, maxCellWidthM: 92, minCellDepthM: 42, maxCellDepthM: 112, minAspect: 0.32, maxAspect: 3.8 }, 0.9, categories(0.2, 0.1, 2, 1.5, 5, 0.3, 6), sizes(0.5, 2, 5, 4), ["industrial"], building({ "industrial-shed": 0.32, "industrial-loading-court": 0.22, "service-court-works": 0.2, "derelict-reclamation-cluster": 0.14, "utility-service-cluster": 0.12 }), uses({ industrial: 0.6, logistics: 0.25, utility: 0.15 })),
  district("light-industrial", "Light Industrial", "industrial-light", { "industrial-yard": 0.36, "logistics-sheds": 0.28, "rotated-bands": 0.22, "irregular-mosaic": 0.14 }, { minCellWidthM: 22, maxCellWidthM: 58, minCellDepthM: 26, maxCellDepthM: 68, minAspect: 0.35, maxAspect: 3.4 }, 0.92, categories(0.5, 0.3, 3, 1, 4, 0.8, 5), sizes(1, 3, 5, 2), ["industrial"], building({ "stacked-workshop": 0.3, "industrial-shed": 0.26, "service-court-works": 0.2, "industrial-loading-court": 0.14, "utility-service-cluster": 0.1 }), uses({ industrial: 0.55, logistics: 0.3, utility: 0.15 })),
  ...
  district("waterfront", "Waterfront", "waterfront", { "waterfront-terraces": 0.46, "rotated-bands": 0.2, "fine-grain-frontage": 0.16, "campus-pavilions": 0.1, "perimeter-courtyard": 0.08 }, { minCellWidthM: 12, maxCellWidthM: 38, minCellDepthM: 16, maxCellDepthM: 50, minAspect: 0.32, maxAspect: 3.8 }, 1.35, categories(5, 4, 1, 0.5, 0.2, 4, 0.4), sizes(3, 5, 3, 1), ["waterfront"], building({ "waterfront-step": 0.36, "residential-slab": 0.2, "dense-perimeter-block": 0.16, "corporate-tower-podium": 0.14, "corner-flatiron": 0.14 }), uses({ "mixed-use": 0.4, residential: 0.3, entertainment: 0.2, commercial: 0.1 })),
  ...
  district("utility-infrastructure", "Utility Infrastructure", "utility", { "industrial-yard": 0.42, "superblock-compound": 0.26, "campus-pavilions": 0.2, "irregular-mosaic": 0.12 }, { minCellWidthM: 30, maxCellWidthM: 76, minCellDepthM: 34, maxCellDepthM: 84, minAspect: 0.42, maxAspect: 3 }, 1.15, categories(0.1, 0.1, 1, 1, 8, 0.5, 5), sizes(0.5, 2, 5, 5), ["industrial", "campus"], building({ "utility-service-cluster": 0.34, "industrial-shed": 0.2, "stacked-workshop": 0.16, "service-court-works": 0.12, "industrial-loading-court": 0.1, "derelict-reclamation-cluster": 0.08 }), uses({ utility: 0.6, industrial: 0.3, logistics: 0.1 })),
  district("derelict-reclamation", "Derelict Reclamation", "derelict", { "irregular-mosaic": 0.38, "industrial-yard": 0.24, "radial-fan": 0.18, "rotated-bands": 0.12, "fine-grain-frontage": 0.08 }, { minCellWidthM: 11, maxCellWidthM: 46, minCellDepthM: 13, maxCellDepthM: 58, minAspect: 0.26, maxAspect: 4.2 }, 1.55, categories(1, 0.5, 1, 6, 4, 1, 4), sizes(2, 4, 4, 3), ["irregular", "industrial"], building({ "derelict-reclamation-cluster": 0.34, "old-city-courtyard": 0.2, "stacked-workshop": 0.18, "market-corner": 0.12, "industrial-shed": 0.1, "service-court-works": 0.06 }), uses({ industrial: 0.4, utility: 0.3, residential: 0.2, "mixed-use": 0.1 }))
]);
