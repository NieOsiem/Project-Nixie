...
export const BUILDING_GRAMMARS: readonly BuildingGrammarDefinition[] = Object.freeze([
  grammar("narrow-shopfront", "Narrow Shopfront", "rectangle", ["fine-grain", "market"], { minWidthM: 8, maxWidthM: 16, minDepthM: 12, maxDepthM: 30, minAreaM2: 100, maxAreaM2: 480, minAspect: 0.25, maxAspect: 3.2 }, { occupancyMin: 0.88, occupancyMax: 0.98, setbackMin: 0.2, setbackMax: 0.8 }, { minM: 14, maxM: 48, skylineBias: 0.3 }, { minMasses: 1, maxMasses: 1, mainWidthFactor: 0.96, mainDepthFactor: 0.92 }, ["parapet", "gable", "shed"], ["shopfront", "masonry-window", "entertainment-arcade"], { rateMin: 0.5, rateMax: 0.95 }, { rateMin: 0.05, rateMax: 0.35 }, { min: 0.25, max: 0.6 }, ["commercial", "entertainment", "mixed-use"], { wall: [0.55, 0.3, 0.15], roof: [0.6, 0.25, 0.15], neon: [0.35, 0.65] }, { coarse: "silhouette", detail: "facade", neon: true }),
  ...
  grammar("industrial-loading-court", "Industrial Loading Court", "u-shape", ["industrial"], { minWidthM: 34, maxWidthM: 84, minDepthM: 28, maxDepthM: 72, minAreaM2: 1000, maxAreaM2: 6000, minAspect: 0.4, maxAspect: 2.6 }, { occupancyMin: 0.5, occupancyMax: 0.8, setbackMin: 1, setbackMax: 3 }, { minM: 10, maxM: 32, skylineBias: 0.08 }, { minMasses: 1, maxMasses: 2, mainWidthFactor: 0.84, mainDepthFactor: 0.78 }, ["sawtooth", "shed", "flat"], ["warehouse-ribs", "industrial-panel", "utility-louvre"], { rateMin: 0.01, rateMax: 0.08 }, { rateMin: 0.7, rateMax: 1 }, { min: 0.4, max: 0.8 }, ["logistics", "industrial", "utility"], { wall: [0.65, 0.24, 0.11], roof: [0.52, 0.31, 0.17], neon: [0.57, 0.43] }, { coarse: "silhouette", detail: "rooftop", neon: false }),
  // Scale boost: cyberpunk metropolis vertical scale
  grammar("dense-perimeter-block", "Dense Perimeter Block", "courtyard", ["fine-grain", "residential", "market", "waterfront"], { minWidthM: 30, maxWidthM: 96, minDepthM: 26, maxDepthM: 84, minAreaM2: 820, maxAreaM2: 8064, minAspect: 0.4, maxAspect: 2.8 }, { occupancyMin: 0.7, occupancyMax: 0.92, setbackMin: 0.4, setbackMax: 1.8 }, { minM: 26, maxM: 140, skylineBias: 0.6 }, { minMasses: 3, maxMasses: 4, mainWidthFactor: 0.96, mainDepthFactor: 0.9 }, ["parapet", "stepped", "flat"], ["masonry-window", "residential-balcony", "shopfront", "office-grid"], { rateMin: 0.2, rateMax: 0.65 }, { rateMin: 0.35, rateMax: 0.85 }, { min: 0.15, max: 0.55 }, ["mixed-use", "residential", "commercial"], { wall: [0.56, 0.3, 0.14], roof: [0.6, 0.28, 0.12], neon: [0.42, 0.58] }, { coarse: "silhouette", detail: "facade", neon: true }),
  grammar("old-city-courtyard", "Old City Courtyard", "courtyard", ["irregular", "fine-grain", "market"], { minWidthM: 20, maxWidthM: 56, minDepthM: 18, maxDepthM: 50, minAreaM2: 380, maxAreaM2: 2800, minAspect: 0.4, maxAspect: 2.8 }, { occupancyMin: 0.68, occupancyMax: 0.9, setbackMin: 0.3, setbackMax: 1 }, { minM: 16, maxM: 72, skylineBias: 0.45 }, { minMasses: 3, maxMasses: 4, mainWidthFactor: 0.9, mainDepthFactor: 0.86 }, ["gable", "shed", "parapet"], ["masonry-window", "shopfront", "industrial-panel"], { rateMin: 0.15, rateMax: 0.55 }, { rateMin: 0.3, rateMax: 0.8 }, { min: 0.35, max: 0.75 }, ["residential", "commercial", "mixed-use", "entertainment"], { wall: [0.48, 0.34, 0.18], roof: [0.5, 0.32, 0.18], neon: [0.38, 0.62] }, { coarse: "silhouette", detail: "facade", neon: true }),
  ...
  grammar("campus-annex", "Campus Annex", "rectangle", ["formal", "campus"], { minWidthM: 4, maxWidthM: 22, minDepthM: 5, maxDepthM: 26, minAreaM2: 60, maxAreaM2: 700, minAspect: 0.25, maxAspect: 3.5 }, { occupancyMin: 0.85, occupancyMax: 0.98, setbackMin: 0.1, setbackMax: 0.5 }, { minM: 8, maxM: 26, skylineBias: 0.15 }, { minMasses: 1, maxMasses: 1, mainWidthFactor: 0.95, mainDepthFactor: 0.9 }, ["flat", "parapet", "shed"], ["office-grid", "masonry-window", "civic-columns"], { rateMin: 0.05, rateMax: 0.3 }, { rateMin: 0.4, rateMax: 0.85 }, { min: 0.05, max: 0.3 }, ["civic", "commercial", "mixed-use"], { wall: [0.72, 0.2, 0.08], roof: [0.7, 0.22, 0.08], neon: [0.62, 0.38] }, { coarse: "silhouette", detail: "facade", neon: false }),
  // Micro-ish grammar for long thin sliver parcels between parallel roads (the
  // european network's narrow faces). Very restrictive aspect lets it hug strips.
  grammar("narrow-strip", "Narrow Strip Building", "rectangle", ["fine-grain", "market"], { minWidthM: 3, maxWidthM: 9, minDepthM: 15, maxDepthM: 60, minAreaM2: 60, maxAreaM2: 540, minAspect: 0.1, maxAspect: 0.5 }, { occupancyMin: 0.85, occupancyMax: 0.98, setbackMin: 0.05, setbackMax: 0.4 }, { minM: 8, maxM: 34, skylineBias: 0.2 }, { minMasses: 1, maxMasses: 1, mainWidthFactor: 0.97, mainDepthFactor: 0.92 }, ["parapet", "gable", "flat"], ["masonry-window", "shopfront", "industrial-panel"], { rateMin: 0.15, rateMax: 0.5 }, { rateMin: 0.4, rateMax: 0.9 }, { min: 0.15, max: 0.5 }, ["residential", "commercial", "mixed-use"], { wall: [0.55, 0.3, 0.15], roof: [0.6, 0.26, 0.14], neon: [0.45, 0.55] }, { coarse: "silhouette", detail: "facade", neon: false })
]);
