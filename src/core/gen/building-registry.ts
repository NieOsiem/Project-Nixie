...
export const BUILDING_GRAMMARS: readonly BuildingGrammarDefinition[] = Object.freeze([
  grammar("narrow-shopfront", "Narrow Shopfront", "rectangle", ["fine-grain", "market"], { minWidthM: 5, maxWidthM: 14, minDepthM: 12, maxDepthM: 30, minAreaM2: 70, maxAreaM2: 420, minAspect: 0.25, maxAspect: 3.2 }, { occupancyMin: 0.82, occupancyMax: 0.96, setbackMin: 0.4, setbackMax: 1.2 }, { minM: 6, maxM: 26, skylineBias: 0.15 }, { minMasses: 1, maxMasses: 1, mainWidthFactor: 0.92, mainDepthFactor: 0.9 }, ["parapet", "gable", "shed"], ["shopfront", "masonry-window", "entertainment-arcade"], { rateMin: 0.5, rateMax: 0.95 }, { rateMin: 0.05, rateMax: 0.35 }, { min: 0.25, max: 0.6 }, ["commercial", "entertainment", "mixed-use"], { wall: [0.55, 0.3, 0.15], roof: [0.6, 0.25, 0.15], neon: [0.35, 0.65] }, { coarse: "silhouette", detail: "facade", neon: true }),
  grammar("residential-slab", "Residential Slab", "rectangle", ["residential", "fine-grain", "waterfront"], { minWidthM: 12, maxWidthM: 42, minDepthM: 10, maxDepthM: 24, minAreaM2: 140, maxAreaM2: 900, minAspect: 0.6, maxAspect: 4 }, { occupancyMin: 0.6, occupancyMax: 0.85, setbackMin: 1.5, setbackMax: 4 }, { minM: 14, maxM: 72, skylineBias: 0.45 }, { minMasses: 1, maxMasses: 2, mainWidthFactor: 0.86, mainDepthFactor: 0.78 }, ["flat", "parapet", "stepped"], ["residential-balcony", "masonry-window", "office-grid"], { rateMin: 0.02, rateMax: 0.2 }, { rateMin: 0.5, rateMax: 0.95 }, { min: 0.1, max: 0.45 }, ["residential", "mixed-use"], { wall: [0.62, 0.26, 0.12], roof: [0.65, 0.25, 0.1], neon: [0.62, 0.38] }, { coarse: "volumes", detail: "facade", neon: false }),
  grammar("stacked-workshop", "Stacked Workshop", "rectangle", ["industrial", "irregular"], { minWidthM: 10, maxWidthM: 30, minDepthM: 14, maxDepthM: 42, minAreaM2: 150, maxAreaM2: 1260, minAspect: 0.3, maxAspect: 2.6 }, { occupancyMin: 0.7, occupancyMax: 0.92, setbackMin: 0.8, setbackMax: 2.5 }, { minM: 8, maxM: 34, skylineBias: 0.25 }, { minMasses: 1, maxMasses: 2, mainWidthFactor: 0.88, mainDepthFactor: 0.84 }, ["sawtooth", "flat", "shed"], ["industrial-panel", "utility-louvre", "warehouse-ribs"], { rateMin: 0.02, rateMax: 0.18 }, { rateMin: 0.6, rateMax: 1 }, { min: 0.35, max: 0.75 }, ["industrial", "utility", "logistics"], { wall: [0.7, 0.2, 0.1], roof: [0.56, 0.3, 0.14], neon: [0.6, 0.4] }, { coarse: "silhouette", detail: "rooftop", neon: false }),
  grammar("industrial-shed", "Industrial Shed", "rectangle", ["industrial"], { minWidthM: 20, maxWidthM: 70, minDepthM: 24, maxDepthM: 80, minAreaM2: 500, maxAreaM2: 5600, minAspect: 0.35, maxAspect: 2.8 }, { occupancyMin: 0.75, occupancyMax: 0.94, setbackMin: 1, setbackMax: 4 }, { minM: 7, maxM: 22, skylineBias: 0.05 }, { minMasses: 1, maxMasses: 3, mainWidthFactor: 0.9, mainDepthFactor: 0.85 }, ["sawtooth", "shed", "gable"], ["warehouse-ribs", "industrial-panel", "utility-louvre"], { rateMin: 0.01, rateMax: 0.12 }, { rateMin: 0.7, rateMax: 1 }, { min: 0.4, max: 0.8 }, ["industrial", "logistics", "utility"], { wall: [0.66, 0.22, 0.12], roof: [0.5, 0.32, 0.18], neon: [0.55, 0.45] }, { coarse: "silhouette", detail: "rooftop", neon: false }),
  grammar("civic-pavilion", "Civic Pavilion", "rectangle", ["formal", "campus"], { minWidthM: 16, maxWidthM: 46, minDepthM: 12, maxDepthM: 34, minAreaM2: 220, maxAreaM2: 1500, minAspect: 0.5, maxAspect: 3 }, { occupancyMin: 0.55, occupancyMax: 0.8, setbackMin: 3, setbackMax: 8 }, { minM: 10, maxM: 42, skylineBias: 0.3 }, { minMasses: 1, maxMasses: 2, mainWidthFactor: 0.82, mainDepthFactor: 0.76 }, ["flat", "curved", "crown"], ["civic-columns", "glass-curtain", "masonry-window"], { rateMin: 0.02, rateMax: 0.2 }, { rateMin: 0.3, rateMax: 0.7 }, { min: 0.05, max: 0.3 }, ["civic", "mixed-use", "commercial"], { wall: [0.78, 0.17, 0.05], roof: [0.76, 0.2, 0.04], neon: [0.72, 0.28] }, { coarse: "volumes", detail: "facade", neon: false }),
  ...
  grammar("utility-service-cluster", "Utility and Service Cluster", "compound", ["industrial", "campus"], { minWidthM: 40, maxWidthM: 110, minDepthM: 34, maxDepthM: 96, minAreaM2: 1400, maxAreaM2: 10500, minAspect: 0.4, maxAspect: 2.8 }, { occupancyMin: 0.35, occupancyMax: 0.6, setbackMin: 2, setbackMax: 8 }, { minM: 6, maxM: 26, skylineBias: 0.1 }, { minMasses: 3, maxMasses: 6, mainWidthFactor: 0.8, mainDepthFactor: 0.74 }, ["flat", "shed", "sawtooth"], ["utility-louvre", "industrial-panel", "warehouse-ribs"], { rateMin: 0.02, rateMax: 0.2 }, { rateMin: 0.8, rateMax: 1 }, { min: 0.3, max: 0.7 }, ["utility", "industrial", "logistics"], { wall: [0.7, 0.2, 0.1], roof: [0.58, 0.28, 0.14], neon: [0.6, 0.4] }, { coarse: "silhouette", detail: "rooftop", neon: false }),
  grammar("derelict-reclamation-cluster", "Derelict Reclamation Cluster", "compound", ["irregular", "industrial"], { minWidthM: 34, maxWidthM: 96, minDepthM: 28, maxDepthM: 84, minAreaM2: 1000, maxAreaM2: 8000, minAspect: 0.35, maxAspect: 3 }, { occupancyMin: 0.28, occupancyMax: 0.52, setbackMin: 3, setbackMax: 12 }, { minM: 5, maxM: 22, skylineBias: 0.05 }, { minMasses: 2, maxMasses: 5, mainWidthFactor: 0.76, mainDepthFactor: 0.7 }, ["shed", "gable", "sawtooth"], ["industrial-panel", "warehouse-ribs", "masonry-window"], { rateMin: 0.01, rateMax: 0.12 }, { rateMin: 0.5, rateMax: 0.95 }, { min: 0.6, max: 1 }, ["industrial", "utility", "residential"], { wall: [0.62, 0.26, 0.12], roof: [0.55, 0.3, 0.15], neon: [0.55, 0.45] }, { coarse: "silhouette", detail: "rooftop", neon: false })
]);
