...
export const BUILDING_GRAMMARS: readonly BuildingGrammarDefinition[] = Object.freeze([
  ...
  // Scale boost: cyberpunk metropolis vertical scale
  grammar("dense-perimeter-block", "Dense Perimeter Block", "courtyard", ["fine-grain", "residential", "market", "waterfront"], { minWidthM: 30, maxWidthM: 96, minDepthM: 26, maxDepthM: 84, minAreaM2: 820, maxAreaM2: 8064, minAspect: 0.4, maxAspect: 2.8 }, { occupancyMin: 0.6, occupancyMax: 0.88, setbackMin: 0.8, setbackMax: 3 }, { minM: 16, maxM: 78, skylineBias: 0.5 }, { minMasses: 3, maxMasses: 4, mainWidthFactor: 0.92, mainDepthFactor: 0.88 }, ["parapet", "stepped", "flat"], ["masonry-window", "residential-balcony", "shopfront", "office-grid"], { rateMin: 0.2, rateMax: 0.65 }, { rateMin: 0.35, rateMax: 0.85 }, { min: 0.15, max: 0.55 }, ["mixed-use", "residential", "commercial"], { wall: [0.56, 0.3, 0.14], roof: [0.6, 0.28, 0.12], neon: [0.42, 0.58] }, { coarse: "silhouette", detail: "facade", neon: true }),
