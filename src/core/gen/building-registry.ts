...
export const BUILDING_GRAMMARS: readonly BuildingGrammarDefinition[] = Object.freeze([
  ...
  grammar("old-city-courtyard", "Old City Courtyard", "courtyard", ["irregular", "fine-grain", "market"], { minWidthM: 20, maxWidthM: 56, minDepthM: 22, maxDepthM: 50, minAreaM2: 380, maxAreaM2: 2800, minAspect: 0.4, maxAspect: 2.8 }, { occupancyMin: 0.68, occupancyMax: 0.9, setbackMin: 0.3, setbackMax: 1 }, { minM: 20, maxM: 72, skylineBias: 0.45 }, { minMasses: 3, maxMasses: 4, mainWidthFactor: 0.9, mainDepthFactor: 0.86 }, ["gable", "shed", "parapet"], ["masonry-window", "shopfront", "industrial-panel"], { rateMin: 0.15, rateMax: 0.55 }, { rateMin: 0.3, rateMax: 0.8 }, { min: 0.35, max: 0.75 }, ["residential", "commercial", "mixed-use", "entertainment"], { wall: [0.48, 0.34, 0.18], roof: [0.5, 0.32, 0.18], neon: [0.38, 0.62] }, { coarse: "silhouette", detail: "facade", neon: true }),
  ...
  grammar("corporate-atrium-block", "Corporate Atrium Block", "courtyard", ["formal", "campus"], { minWidthM: 36, maxWidthM: 96, minDepthM: 34, maxDepthM: 84, minAreaM2: 1100, maxAreaM2: 8000, minAspect: 0.4, maxAspect: 2.8 }, { occupancyMin: 0.6, occupancyMax: 0.86, setbackMin: 2, setbackMax: 6 }, { minM: 50, maxM: 200, skylineBias: 0.85 }, { minMasses: 3, maxMasses: 4, mainWidthFactor: 0.94, mainDepthFactor: 0.9 }, ["flat", "crown", "curved"], ["glass-curtain", "office-grid", "civic-columns"], { rateMin: 0.05, rateMax: 0.25 }, { rateMin: 0.45, rateMax: 0.9 }, { min: 0.03, max: 0.2 }, ["commercial", "civic", "mixed-use"], { wall: [0.64, 0.26, 0.1], roof: [0.66, 0.24, 0.1], neon: [0.55, 0.45] }, { coarse: "volumes", detail: "facade", neon: false }),
  // Scale boost: cyberpunk metropolis vertical scale
