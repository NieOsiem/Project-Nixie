...
Hooks.once("init", () => {
  ...
  module.api = {
    ...
    generationState,
    generationActive,
    // WHY: full-generation requests carry the pre-dialog preflight pinned as the clear
    // confirmation; API consumers build it from their own preflight before dialogs.
    confirmationForPreflight: clearConfirmationFor,
    startFullGeneration,
    retryFullGeneration,
    generateNewSeed,
    randomizeEntireCity,
